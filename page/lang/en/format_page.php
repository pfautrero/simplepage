...
$string['helpSections'] = "This part only concerns courses built under moodle 1.9 using FlexPage1. Since moodle 2, a navigation menu follows student during his session on the plateform. This menu displays studied courses and their sections. FlexPage did not manage these sections and thus, there is no relation between moodle sections and FlexPage pages. This module help you to delete these sections or to associate sections and pages.";
