      ...
      // Remote allowed or DataURI
        ...
        // From remote
          ...
          if ($datauri) {
			...
			$pos = strpos($full_url, "file.php");
			if ($pos !== false) {
				$end_url = substr($full_url,$pos+strlen("file.php"));
				global $CFG;
				$full_url = $CFG->dataroot.$end_url;
			}
          ...
          if ( strlen($image) == 0 ) {
            $msg = ($datauri ? "Data-URI could not be parsed" : "image introuvable");
